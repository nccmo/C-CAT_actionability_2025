---
title: "TRK_annotation"
author: "Yuki Saito"
date: "2025-02-12"
output: html_document
---

- R markdown script to annotate the use of TRK inhibitors for each case.
...
# read in ref data
ref_df <- read_ref_csv("../../ref/evidenceA_drug_ver202406/NTRK_fusion_PanCan_drug.csv")
print(ref_df)
...
# save
pre_treatment_data %>% 
  write_excel_csv("result/table/merged/merged_pre_treatment_data_TRK_inhibitor_automatic_annotation.csv", na = "")
post_treatment_data %>% 
  write_excel_csv("result/table/merged/merged_post_treatment_data_TRK_inhibitor_automatic_annotation.csv", na = "")
```
...
post_treatment_samples2_with_response <- post_treatment_samples2_with_response %>%
  rename(PostEP_TRK = PostEP_automatic_lenient,
         PostEP_TRK_best_response = PostEP_automatic_lenient_response_name,
         PostEP_TRK_startdate = PostEP_regimen_startdate)
```
